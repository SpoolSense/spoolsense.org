...
<tr><td>HA discovery traffic reduced ~80%</td><td><span class="repo-tag">Scanner</span></td><td><span class="version-tag">v1.6.1</span></td></tr>
<tr><td>HTTP connection reuse for Spoolman</td><td><span class="repo-tag">Scanner</span></td><td><span class="version-tag">v1.6.1</span></td></tr>
